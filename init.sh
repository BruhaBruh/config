...
npm set-script lint 'yarn lint:eslint && yarn lint:stylelint'
npm set-script lint:eslint 'eslint src'
npm set-script lint:stylelint 'stylelint src'
npm set-script format 'yarn format:prettier && yarn format:eslint && yarn format:stylelint'
npm set-script format:prettier 'prettier --write src'
npm set-script format:eslint 'eslint --fix src'
npm set-script format:stylelint 'stylelint --fix src'
